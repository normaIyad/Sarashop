        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Carts", x => new { x.ProductId, x.ApplecationUserId });
                    table.ForeignKey(
                        name: "FK_Carts_AspNetUsers_ApplecationUserId",
                        column: x => x.ApplecationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Carts_Prodacts_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Carts_ApplecationUserId",
                table: "Carts",
